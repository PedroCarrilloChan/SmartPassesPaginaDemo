                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Juan" {...field} className="h-10 sm:h-11 bg-white/20 backdrop-blur-md text-black placeholder:text-white/60" />
                      </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Pérez" {...field} className="h-10 sm:h-11 bg-white/20 backdrop-blur-md text-black placeholder:text-white/60" />
                      </FormControl>
                      <FormMessage className="text-xs sm:text-sm font-medium text-red-300" />
                    </FormItem>
                  )}
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          ...
                          {...field}
                          className="h-10 sm:h-11 bg-white/20 backdrop-blur-md text-black placeholder:text-white/60"
                        />
                      </FormControl>
                      <FormMessage className="text-xs sm:text-sm font-medium text-red-300" />
                    </FormItem>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <PhoneInput
                          ...
                          inputClass="w-full p-2 rounded-md border border-white/30 bg-white/20 backdrop-blur-md text-black h-10 sm:h-11"
